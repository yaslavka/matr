                    ...
                    <div className="card">
                      <div className="card__body">
                        <div className="list-info list-info--lg-space list-info--horizontal">
                          ...
                          <div className="list-info__group">
                            <div className="list-info__label">Транзитный баланс</div>
                            <div className="list-info__value">
                              {formatter
                          ...
                          <div className="list-info__group">
                            ...
                            <div className="list-info__value">{userInfo.clones || 0}</div>
                          </div>
                          <div className="list-info__group">
                            <div className="list-info__label">Кометы</div>
                            <div className="list-info__value">{userInfo.comets || 0}</div>
                          </div>
                          <div className="list-info__group">
